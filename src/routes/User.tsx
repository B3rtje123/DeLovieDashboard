        ...
        <div className="max-w-sm md:max-w-2xl lg:max-w-4xl xl:max-w-7xl mx-auto pb-8">
          ...
          <h1 className="flex items-center gap-2 text-4xl text-textBlack font-semibold mt-7">
            ...
            <button className='text-4xl p-4 transition-all duration-200 ease-in-out
             ...
             hover:outline-none  hover:ring-2 hover:ring-darkblue' type='submit' onClick={() => nameUpdate()}><MdOutlineKeyboardArrowRight /></button>
          </h1>

          <div className='grid grid-cols-1 grid-rows-3 gap-8 
          lg:grid-cols-2 lg:grid-rows-2 mt-8'>
            {/* movement info */}
            <section className='mx-auto bg-cardGreen/40 p-4 overflow-x-scroll max-w-sm md:max-w-full md:overflow-hidden '>
            ...
            <section className='bg-cardGreen/40 p-4 max-h-min'> 
              <div className=''>
            ...
            <section className='mx-auto p-4 max-h-72 lg:col-span-2 bg-cardGreen/40'>
